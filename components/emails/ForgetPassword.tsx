  ...
  return (
    <Html lang='en'>
      <div style={containerStyle}>
        ...
        <Text>
          Thanks for helping us keep your account secure! You have requested to
          reset your password for your Luuqad.com account. Please click the
          button below to proceed with the password reset process.
        </Text>
        <br />
        <a style={button} href={resetLink}>
          Reset password{" "}
        </a>
        <br />
        <br />
