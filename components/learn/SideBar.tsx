  ...
  return (
    <div>
      <ul className="space-y-2">
        <li className="flex flex-row items-center w-full px-6 py-3 pb-4 text-base font-bold tracking-widest text-blue-400 bg-blue-100 border-2 border-blue-200 rounded-lg cursor-pointer ">
          <svg
          ...
          <span className="pt-2 pl-3">LEARN</span>
        </li>
        <li className="flex flex-row items-center w-full px-6 py-3 pb-4 text-base font-bold tracking-widest text-green-500 transition-colors duration-200 rounded-lg cursor-pointer hover:bg-green-100 hover:text-green-600 ">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            id="Layer_1"
            data-name="Layer 1"
          ...
          <span className="pt-2 pl-3">LETTERS</span>
        </li>
        <li className="flex flex-row items-center w-full px-6 py-3 pb-4 text-base font-bold tracking-widest text-green-500 transition-colors duration-200 rounded-lg cursor-pointer hover:bg-green-100 hover:text-green-600 ">
          <svg
            xmlns="http://www.w3.org/2000/svg"
          ...
          <span className="pt-2 pl-3">PRACTICE</span>
        </li>
        <li className="flex flex-row items-center w-full px-6 py-3 pb-4 text-base font-bold tracking-widest text-green-500 transition-colors duration-200 rounded-lg cursor-pointer hover:bg-green-100 hover:text-green-600 ">
          <svg
            xmlns="http://www.w3.org/2000/svg"
          ...
          <span className="pt-2 pl-3">LEADERBOARD</span>
        </li>
        <li className="flex flex-row items-center w-full px-6 py-3 pb-4 text-base font-bold tracking-widest text-green-500 transition-colors duration-200 rounded-lg cursor-pointer hover:bg-green-100 hover:text-green-600 ">
          <svg
            xmlns="http://www.w3.org/2000/svg"
          ...
          <span className="pt-2 pl-3">PROFILE</span>
        </li>
        <li className="flex flex-row items-center w-full px-6 py-3 pb-4 text-base font-bold tracking-widest text-green-500 transition-colors duration-200 rounded-lg cursor-pointer hover:bg-green-100 hover:text-green-600 ">
          <svg
            xmlns="http://www.w3.org/2000/svg"
          ...
          <span className="pt-2 pl-3">SETTINGS</span>
        </li>
        <li className="flex flex-row items-center w-full px-6 py-3 pb-4 text-base font-bold tracking-widest text-green-500 transition-colors duration-200 rounded-lg cursor-pointer hover:bg-green-100 hover:text-green-600 ">
          <svg
            xmlns="http://www.w3.org/2000/svg"
          ...
          <span className="pt-2 pl-3">LOGOUT</span>
        </li>
      </ul>
    </div>
  );
