  ...
  return (
    <div>
      <ul className="inline-block w-auto space-y-2">
        ...
        <li>
          <NavLink href="/learn/leaderboard">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              id="Layer_1"
              data-name="Layer 1"
...
const NavLink = ({
  ...
  const activeClass =
    "text-blue-400 bg-blue-100 border-2 border-blue-200 rounded-lg cursor-pointer"
  const inactiveClass =
    "text-green-500 transition-colors duration-200 rounded-lg cursor-pointer hover:bg-green-100 hover:text-green-600"
