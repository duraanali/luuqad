...
const  SideBar = () => {
  return (
    <div>
      <ul className="space-y-2 w-auto inline-block">
        <li className="w-full text-base font-bold text-blue-400 bg-blue-100 border-2 border-blue-200 rounded-lg px-4 py-3 pb-4 cursor-pointer tracking-widest flex flex-row items-center ">
          <svg
          ...
          <span className="pl-3 pt-2 c-xl:hidden ">LEARN</span>
        </li>
        <li className="w-full text-base font-bold text-green-500 rounded-lg px-4 py-3 pb-4 hover:bg-green-100 hover:text-green-600 transition-colors duration-200 cursor-pointer tracking-widest flex flex-row items-center ">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            id="Layer_1"
            data-name="Layer 1"
          ...
          <span className="pl-3 pt-2 c-xl:hidden">LETTERS</span>
        </li>
        <li className="w-full text-base font-bold text-green-500 rounded-lg px-4 py-3 pb-4 hover:bg-green-100 hover:text-green-600 transition-colors duration-200 cursor-pointer tracking-widest flex flex-row items-center ">
          <svg
            xmlns="http://www.w3.org/2000/svg"
          ...
          <span className="pl-3 pt-2 c-xl:hidden">PRACTICE</span>
        </li>
        <li className="w-full text-base font-bold text-green-500 rounded-lg px-4 py-3 pb-4 hover:bg-green-100 hover:text-green-600 transition-colors duration-200 cursor-pointer tracking-widest flex flex-row items-center ">
          <svg
            xmlns="http://www.w3.org/2000/svg"
          ...
          <span className="pl-3 pt-2 c-xl:hidden">LEADERBOARD</span>
        </li>
        <li className="w-full text-base font-bold text-green-500 rounded-lg px-4 py-3 pb-4 hover:bg-green-100 hover:text-green-600 transition-colors duration-200 cursor-pointer tracking-widest flex flex-row items-center ">
          <svg
            xmlns="http://www.w3.org/2000/svg"
          ...
          <span className="pl-3 pt-2 c-xl:hidden">PROFILE</span>
        </li>
        <li className="w-full text-base font-bold text-green-500 rounded-lg px-4 py-3 pb-4 hover:bg-green-100 hover:text-green-600 transition-colors duration-200 cursor-pointer tracking-widest flex flex-row items-center ">
          <svg
            xmlns="http://www.w3.org/2000/svg"
          ...
          <span className="pl-3 pt-2 c-xl:hidden">SETTINGS</span>
        </li>
        <li className="w-full text-base font-bold text-green-500 rounded-lg px-4 py-3 pb-4 hover:bg-green-100 hover:text-green-600 transition-colors duration-200 cursor-pointer tracking-widest flex flex-row items-center ">
          <svg
            xmlns="http://www.w3.org/2000/svg"
          ...
          <span className="pl-3 pt-2 c-xl:hidden">LOGOUT</span>
        </li>
      </ul>
    </div>
  );
