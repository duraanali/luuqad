  ...
  return (
    <div className="min-h-full flex items-center justify-center  px-4 sm:px-6 lg:px-8">
      <div className="max-w-sm">
        <div>
          <h1 className="mt-20 text-center text-3xl font-extrabold">Forget password</h1>
          <p className="text-center mt-3 font-medium text-xl">We Will send you instructions on how to reset your password by email</p>
        </div>
